...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onload="return addCalculator(6);">
    	<div id="container">
        <div id="min790">
	          ...
	          <div id="calculators-menu">
	            <ul>
	                <li style="backgroun-color: #f5f5eb; height: 80px;">
	                   <form id="claimant-defendant" onSubmit="return false;">
	                      ...
	                      <div style="height: 26px; padding:5px 0 5px 0;">
	                           <div class="width-100"><span>Case Details</span></div><div  style="width:165px;">&nbsp;<input id="ref" type="text"/></div><div class="width-60"></div>
	                      </div>
