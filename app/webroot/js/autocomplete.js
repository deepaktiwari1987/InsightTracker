...
Autocomplete.prototype = {
  ...
  initialize: function() {
	...
	mobile_check = window.mobile_check;
    div.update('<div class="autocomplete-w1"><div class="autocomplete-w2"><div class="autocomplete'+mobile_check+'" id="Autocomplete_' + this.id + '" style="display:none; width:' + this.options.width + 'px;"></div></div></div>');
  ...
  suggest: function() {
    ...
    var re = new RegExp('' + this.currentValue.match(/\w+/g).join('|\\b'), 'gi');
