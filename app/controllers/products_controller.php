        ...
        try {
            ...
            if (isset($this->data) && !empty($this->data) || $insightId > 0 || isset($postval)) {
                ...
                if (isset($search_string) && $search_string != "") {
                    ...
                    $conditionsArr = array_merge($conditionsArr, array(' ( Insight.what_insight_type LIKE "' . '%' . strtolower($search_string) . '%' . '"' .
                        $insightid .
            ...
            if ($this->Session->read('conditionsArr') != "") {
                 ...
                 */
                //echo "<pre>";print_r(unserialize($this->Session->read('conditionsArr')));die;
...
//			$EmailFrom = 	LNG_UK_INSIGHT_TRACKER_EMAIL;	
    ...
    function send_insight_claim_email($id = '') {
        ...
        # Import Insight modelsend_insight_claim_email
        App::import('Model', 'Insight');
        # Create Insight model object
        $this->Insight = new Insight();
...
# End function
     ...
     * This function confirms that the User trying to access the legal is a delegated SME or the Contributor of the legalqa.
     * The function is called when SME try to edit the legalqa details from search result page.
     * @param Integer insight_id
     */
    function legalqaconfirmeddelegation($insight_id = '') {
