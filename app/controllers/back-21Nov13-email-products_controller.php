 ...
 */
 ...
 define("LNG_UK_INSIGHT_TRACKER_EMAIL", "insighttracker@lexisnexis.co.uk");
 define("LNG_UK_INSIGHT_ERROR_EMAIL", "insighttracker@lexisnexis.co.uk");
	...
	*/
	function add_export_array($valueSet, $type) 
	{
		...
		{       
			...
			$arr[16] = $valueSet['recommended_actions'];
		...
		{   
                            ...
                            $arr[13] = $valueSet['who_competitorName'];
