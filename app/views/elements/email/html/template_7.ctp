...
<table border="0" cellspacing = "5" cellpadding = "5">
	...
	<tr>
		<td>Please be advised new feedback (ref <?php echo $id;?>) has been delegated to you in the Feedback Tracker; <br/>
Follow the link to:
<br/>
<table width="100%" border="0" cellspacing="0" cellpadding="3">
		  <tr>
			<td width="3%" align="center">1.</td>
			<td>&nbsp;review the feedback and confirm it is correctly allocated to you as the SME</td>
		  </tr>
		  <tr>
