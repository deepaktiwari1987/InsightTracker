          ...
          <div class="search" id="top_header_box">
                 ...
                 if (empty($current_user_name) && empty($current_user_id)) { 
                  ...
                  ?>
                    ...
                    <span>
                                <div class="searchbox">
								<form action="#" onsubmit="return setFormSubmit('<?php print md5(time()); ?>');"  name="loginform">
								<table border="0">
									<tr>
										<td><div class="text">Please enter your user ID: </div></td>
										<td><input name="username" type="text" id="username" class="logintextbox" /></td>
										<td><div class="ok"><a href="#" id="setusername" onclick="setFormSubmit('<?php print md5(time()); ?>');"><img src="<?php echo IMAGE_URL?>/ok.jpg" alt="ok" align="absmiddle" /></a></div></td>
									</tr>
									<tr  id="username_notvalid"><td>&nbsp;</td>
										<td colspan="2">
											<div class="notvalid_err">Username not recognised.</div>
										</td>
									</tr>
								</table>
								</form>
