...
* Functionality / Description : The purpose of this file is to display a form to search insights in the application.
* @Modified By: Gaurav Saini
* @Modified Functionality: New lookup field added to search Issues.
...
<?php //echo $form->create('Product', array('action'=>'/resultsall','id'=>'productSearchInsightForm','name'=>'productSearchInsightForm', 'method' => 'post'));?>
<?php echo $form->create('Product', array('action'=>'/results','id'=>'productSearchInsightForm','name'=>'productSearchInsightForm', 'method' => 'post'));?>
	...
	<div class="hr-row">
		...
		<tr>
			...
			<input type="text" onfocus="if(this.value=='Free Text Search') this.value='';" onblur="if(this.value=='') this.value='Free Text Search';" value="Free Text Search" class="text-box" alt="Search" maxlength="150" size="50" id="data[Product][free_search_text]" name="data[Product][free_search_text]"></td>
		        <td width="50%"><?php echo $form->input('what_insight_type', array('label'=>false,'options' => $arrinsighttype,'div'=>false,'value' =>'Insight type')); ?></td>
		...
		<!--<tr>
			...
			<tr>
				...
				<td>Role: &nbsp; <br /> <?php echo $form->input('who_contact_role',array('label'=>false,'class'=>'text-box1','size'=>'25','div'=>false));?></td> 
	...
	<div class="hr-row">
		...
		<tr>
			...
			<tr>
				...
				<td class="last_td">Selling Obstacles:&nbsp;
				<div>
