						...
						<tr>
							<td style="padding: 0px !important;">		
								<div class="buttonrow" style="text-align:center;">
									<input type="button" name="BtnSME" value="Yes" onclick="LegalqaClaimInsight();"/>
									&nbsp;&nbsp;
									<input type="button" name="BtnContributor" value="No" onclick="javascript:DontLegalqaClaimInsight();"/>
								</div>		
							</td>
						</tr>
			</table>  
...
function LegalqaClaimInsight()
{
	...
	if(current_user_id > 0)
	{
		...
		*/
                var ClaimURL	= "<?php echo SITE_URL.'/products/legalqaclaimpath/'. $insight_id.'/'.$this->Session->read('current_user_id');?>";
		var RedirectURL = "<?php print SITE_URL . '/products/legalqarecords/' . $insight_id; ?>";
		legalqaclaimInsight(ClaimURL, RedirectURL);
	}
	else
	{
...
function DontLegalqaClaimInsight()
{	
	/*
	...
	*/	
	...
	parent.parent.document.getElementById('ProductResponseSentToCustomer_dummy_label').style.display = 'block';
