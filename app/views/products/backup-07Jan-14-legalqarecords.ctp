		...
		<tr>
			<td width="50%" valign="top">
				...
				<?php } ?>				
                        ...
                        <td width="50%" valign="top">
                            <span id='ProductResponseSentToCustomer_dummy_label' style="display: none;"><?php echo $form->input('respons_sent_to_customer',array('rows'=>'7','label'=>false,'div'=>false, 'value'=>$respons_sent_to_customer, 'style'=>'width:477px;height:150px;'));?></span>
			</td>
                        <?php }else { ?>
<!--                        <span id='ProductResponseSentToCustomer_dummy_label'><?php //echo $form->input('respons_sent_to_customer',array('rows'=>'7','label'=>false,'class'=>'readonlycls','div'=>false,'readonly'=>true, 'style'=>'width:477px;height:150px;'));?></span>
			-->
                        <?php } ?>
                    </tr>
		</table>
...
//			elseif (($delegation_confirmed == 'N' && $current_user_id == $deligated_to_selected && $deligated_to_selected > 0) || ($current_user_id != $deligated_to_selected  && $deligated_to_selected > 0)){ 
				...
				**/
				...
				<input name="cancel" type="button" value="Reply" id="EditBtn" onclick="activateLegalqaEditFields('ProductContentTypeId', 'ProductPracticeAreaId', 'ProductInsightSummary', 'ProductDoAction', 'ProductIssueIcon', 'submitProductInsight', 'Product', 'Competitorname', 'Productfamilyname', 'Productname', 'Firm');" />&nbsp;	
