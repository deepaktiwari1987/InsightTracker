...
function hideNconfirm()
{
	...
	if(current_user_id == delegated_SME_Id)
	{
		...
		*/
		var ConfirmDelegationURL	= "<?php echo SITE_URL.'/products/legalqaconfirmeddelegation/'. $insight_id;?>";
...
{	
	...
	var popupURL = "<?php echo SITE_URL.'/products/legalqacontact/'. $insight_id;?>";
