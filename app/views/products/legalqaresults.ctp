...
* Functionality / Description : New page added for workflow B
    *Following  changes
        ...
        i: Add Comments rename to "Customer Response"
...
<div id="textcontainer">
  <?php 
			...
			if(isset($final_result) && count($final_result)>0) {
				$exportlink = SITE_URL."/products/legalqaexporttoexcel/product";
...
?>
<?php echo $form->create('Product', array('action'=>'/legalqaresults','id'=>'productInsightForm','name'=>'productInsightForm', 'method' => 'post'));?>
		 ...
		 <td width="270px"  style="padding:10px 10px 10px 10px !important" <?php echo $bgcolor_left; ?> >
		 	<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<td><b>Feedback Id</b> - <?php print $final_result[$i]['id']; ?>				
			     ...
			     <tr>
				<td><b>Origin of Question</b>? <?php //print (trim($final_result[$i]['what_how_come']) != "")?" - ".$final_result[$i]['what_how_come']:'-'; ?>
				<?php 
		  ...
		  <td style="padding-right:15px !important; padding-left:8px !important; _position:relative; vertical-align:top; " <?php echo $bgcolor_right; ?>  valign="top" >
			...
			<table border="0" cellspacing="0" cellpadding="0" width="410px" height="50%">
			    ...
			    <tr>
			      <td  height="25px;" valign="bottom"><h4>Question?</h4></td>
			 ...
			 <table border="0" cellspacing="0" cellpadding="0" >
			     <tr>			   
					...
					<td align="left" style="white-space:nowrap">
						...
						<a href="<?php print SITE_URL . '/products/legalqarecords/' . $final_result[$i]['id']; ?>" title="Click Here">Click Here</a><br/>
