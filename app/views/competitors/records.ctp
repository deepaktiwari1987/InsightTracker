<div id="textcontainer">
	<div class="hr-row">
	    <?php echo $form->create('Competitor', array('type'=>'file','action'=>'/records/'.$id,'id'=>'competitorInsightForm','name'=>'competitorInsightForm', 'method' => 'post'));?>
		<table width="100%" border="0" cellspacing="5" cellpadding="0">
		<div id="errCompetitorAttachmentExtension" class="successmsg" style="display:<?php echo $successDivSave?>;">Record saved successfully.</div>
		<tr>
		...
		<tr>
			<td colspan="6" class="selectoption">
				<label>
					<input name="data[Competitor][what_insight_type]" id="what_insight_type1" type="radio" value="1" onclick="javascript:changeInsightType(this.value,'customers','index','<?php echo SITE_URL?>');" disabled="disabled"/>
					Customer Insight
				</label>
				<label>
					<input name="data[Competitor][what_insight_type]" id="what_insight_type2" type="radio" value="2" onclick="javascript:changeInsightType(this.value,'markets','index','<?php echo SITE_URL?>');"  disabled="disabled"/>
					Market Insight
				</label>
				<label>
					<input name="data[Competitor][what_insight_type]" id="what_insight_type3" type="radio" value="3" onclick="javascript:changeInsightType(this.value,'products','index','<?php echo SITE_URL?>');"  disabled="disabled"/>
					Product Insight
				</label>
				<label>
					<input name="data[Competitor][what_insight_type]" id="what_insight_type4" type="radio" value="4" onclick="javascript:changeInsightType(this.value,'competitors','index','<?php echo SITE_URL?>');" checked="checked"  disabled="disabled"/>
					Competitor Insight
				</label>
			</td>
		</tr>
	...
	<div class="hr-row">
		...
		<tr>
			...
			<td width="82%"><?php echo $ajax->autoComplete('Competitorname.competitor_id', '/Competitors/autoCompleteCompetitorNames', array('minChars' => 1,'class'=>'search-input-new',  'readonly' => 'readonly', 'class' => 'text-box1 readonlycls'))?></td>
		</tr>
		</table>
	</div>
	...
	<div class="hr-row">
		...
		<tr>
			<td><?php echo $form->input('insight_summary',array('rows'=>'7','label'=>false,'class'=>'summary readonlycls','div'=>false,  'readonly' => 'readonly'));?>
			</td>
		</tr>
		</table>
	</div>
			...
			<td>
				...
				<tr>
					<td width="33%" valign="top"><h4>LexisNexis Product Family Name</h4>
						<div>
						<?php if($edit_flag == "") { ?>						
							<span id='CompetitorRelatesProductFamilyId_dummy_label'><?php echo $form->input('relates_product_family_id_dummy', array('label'=>false,'options' => $arrProductFamilyNames,'div'=>false, 'disabled' => 'disabled', 'selected'=>$product_family_name_label)); ?></span>
					...
					<td width="34%" valign="top"><h4>Practice Area</h4>
						<div>
						<?php if($edit_flag == "") { ?>						
							<span id='CompetitorPracticeAreaId_dummy_label'><?php echo $form->input('practice_area_id_dummy', array('label'=>false,'options' => $arrPracticeArea,'div'=>false,  'disabled' => 'disabled', 'selected' => $practice_area_label)); ?></span>
	...
	<div class="hr-row">
		...
		<tr>
			<td>
			<?php if($edit_flag == "") { ?>				
				<span id='CompetitorDoAction_dummy_label'><?php echo $form->input('do_action_dummy',array('rows'=>'7','label'=>false,'class'=>'summary readonlycls','div'=>false, 'readonly' => 'readonly', 'value' => $do_action_dummy));?></span>
			...
			<td>
				...
				<tr><?php 
						if(isset($attachment_real_name) && trim($attachment_real_name) != ""){
							$fileattached = '<a id="attachment_namelink"  href="#" onclick="javascript:open_attachment(\''.SITE_URL.'/files/competitor/'.$attachment_name.'\'); return false;">'.$attachment_real_name.'</a>
											<a class="attachment_removelink" id="attachment_removelink" style="display:none;" href="" onclick="javscript: remove_attachment(\''.SITE_URL.'/competitors/remove_attachment/'.$id.'/'.base64_encode($attachment_name).'\',\'Competitor\'); return false;"><img align="absmiddle" src="'.SITE_URL.'/img/remove.gif"/></a><script>var attachmentfound = true;</script>';
						}else{
				...
				<tr>
					...
					<td width="83%">
						<label>
							<?php if($edit_flag == "") { ?>
								<?php echo $form->hidden('Competitor.old_attachment_name',array('value'=>$attachment_name)); ?>
	...
	<div class="hr-row">
      ...
      ?>
          ...
          <td width="33%" valign="top">Current Status: <?php echo $form->input('insight_status', array('label'=>false,'options' => $arrCurrentStatus, 'div'=>false, 'selected'=>$current_status_label, 'disabled' => TRUE, 'onchange' => 'show_delegated_to("Competitor");')); ?></td>
	...
	<div class="buttonrow"><input name="cancel" type="button" value="Edit" onclick="activateEditFields('CompetitorRelatesProductFamilyId', 'CompetitorPracticeAreaId', 'CompetitorDoAction', 'submitCompetitorsInsight', 'Competitor');" />&nbsp;
	<input name="submitCompetitorsInsight" id="submitCompetitorsInsight" type="submit" value="Submit" /></div>
